(function (global, factory) {
    ...
    function as (units) {
        ...
        if (units === 'month' || units === 'year') {
            ...
            switch (units) {
                case 'week'   : return days / 7     + milliseconds / 6048e5; break;
                case 'day'    : return days         + milliseconds / 864e5; break;
                case 'hour'   : return days * 24    + milliseconds / 36e5; break;
                case 'minute' : return days * 1440  + milliseconds / 6e4; break;
                case 'second' : return days * 86400 + milliseconds / 1000; break;
                // Math.floor prevents floating point math errors here
                case 'millisecond': return Math.floor(days * 864e5) + milliseconds; break;
                default: throw new Error('Unknown unit ' + units);  break;          
            }
        }
    }
    ...
    function specialMutationForYears(number) {
        ...
        case 5:
        case 9:
            return number + ' bloaz'; break;
        default:
            return number + ' vloaz'; break;
        }
    }
    ...
    var el = _moment__default.defineLocale('el', {
        ...
        calendarEl : {
            ...
            lastWeek : function () {
                switch (this.day()) {
                    case 6:
                        return '[το προηγούμενο] dddd [{}] LT'; break;
                    default:
                        return '[την προηγούμενη] dddd [{}] LT'; break;
                }
            },
            sameElse : 'L'
        },
    ...
    var it = _moment__default.defineLocale('it', {
        ...
        calendar : {
            ...
            lastWeek: function () {
                switch (this.day()) {
                    case 0:
                        return '[la scorsa] dddd [alle] LT'; break;
                    default:
                        return '[lo scorso] dddd [alle] LT'; break;
                }
            },
            sameElse: 'L'
        },
        ...
        calendar: {
            ...
            lastWeek: function () {
                ...
                switch (this.day()) {
                    case 2:
                    case 4:
                        return '[Leschten] dddd [um] LT'; break;
                    default:
                        return '[Leschte] dddd [um] LT'; break;
                }
            }
        },
        relativeTime : {
    ...
    var pl = _moment__default.defineLocale('pl', {
        ...
        calendar : {
            ...
            lastWeek: function () {
                switch (this.day()) {
                case 0:
                    return '[W zeszłą niedzielę o] LT'; break;
                case 3:
                    return '[W zeszłą środę o] LT'; break;
                case 6:
                    return '[W zeszłą sobotę o] LT'; break;
                default:
                    return '[W zeszły] dddd [o] LT'; break;
                }
            },
            sameElse: 'L'
        },
