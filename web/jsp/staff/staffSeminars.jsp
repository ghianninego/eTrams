			 		...
			 		<div class="row options">
						...
						<div class="col-sm-offset-4 col-sm-3">
							<form method="post" action="../../dbcontrol">
								...
								<div class="input-group">
									<span class="input-group-btn">
										<a class="btn btn-default" href="../../dbcontrol?requestType=goToStaffSeminar"><span class="glyphicon glyphicon-refresh"></span></a>
									</span>
							...
							<div class="panel panel-default" id="dataContent_<%= rs.getInt(1)%>" data-semname="<%=rs.getString(3)%>" 
								...
								<% } %>
									...
									<li class="list-group-item setting1">
  										<a href="../../dbcontrol?requestType=goToStaffSession&seminarID=<%=rs.getInt(1)%>&seminarName=<%=rs.getString(3)%>">View Sessions</a>
									</li>
								</ul>
							</div>
						</div>
