		...
		<div class="row">
			<div class="col-md-12">
				<h1 class="page-header">
					<small><a href="participantSeminars.jsp">Seminar Name</a>
						/ </small> Sessions
				</h1>
				...
				<div class="content">
					...
					<div class="row" id="ssList">
						...
						<div class="col-sm-6 col-md-3">
							<% if (rs.getInt(11) == 1) { %>
								<button class="thumbnail" data-trigger="focus" 
									data-html="true" data-placement="bottom" style="pointer-events:none">
								...
								<button class="thumbnail" data-toggle="popover" data-trigger="focus" 
									data-html="true" data-placement="bottom" data-content="
  										<div class='someButton'>
  											...
  											<p>//If hindi registered yung user</p>
  											
  											<a class='btn btn-yellow btn-block' href='coordinatorManageCertification.jsp'>Unregister</a>
  											<p>//If registered yung user</p>
  										</div>
  									">
