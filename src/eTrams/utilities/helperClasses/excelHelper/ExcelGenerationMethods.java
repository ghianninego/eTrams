...
public static void F1(Connection conn, XSSFWorkbook wb){
		...
		for(int i = 2; i <= 37;){
			if(month < i-x){
				SqlOpsforExcelGen.session_monthly(conn, wb, sp, cell, s13, i, i-x, month, i-x);
				SqlOpsforExcelGen.session_monthly_incomp(conn, wb, sp, cell, s13, i+1, i-x, month, i-x);
				...
				SqlOpsforExcelGen.session_monthly(conn, wb, sp, cell, s11, i, i-x,month, i-x);
				SqlOpsforExcelGen.session_monthly_incomp(conn, wb, sp, cell, s11, i+1, i-x,month, i-x);
	...
	public static void F2(Connection conn, XSSFWorkbook wb){
		...
		if(month > 7){ //1st term
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s11, 2, 8, 12, month, 7);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s11, 3, 8, 12, month,7);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s11, 4, 8, 12, month,7);

			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s13, 5, 1, 5, 7, month);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s13, 6, 1, 5, 7, month);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s13, 7, 1, 5, 7, month);
			
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s13, 8, 6, 7, 7, month);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s13, 9, 6, 7, 7, month);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s13, 10, 6, 7, 7, month);
		}
		else if(month < 6){ //2nd term
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s11, 2, 8, 12, 6,month);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s11, 3, 8, 12, 6,month);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s11, 4, 8, 12, 6,month);

			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s11, 5, 1, 5, 6,month);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s11, 6,  1, 5, 6,month);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s11, 7, 1, 5, 6,month);
			
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s13, 8, 6, 7, month, 6);
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s13, 9, 6, 7, month, 6);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s13, 10, 6, 7, month, 6);
		}
		else if(month == 6 || month == 7){ //third term
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s11, 2, 8, 12, 7, 6);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s11, 3,  8, 12, 7, 6);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s11, 4, 8, 12, 7, 6);

			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s11, 5, 1, 5, 7, 6);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s11, 6,1, 5, 7, 6);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s11, 7, 1, 5, 7, 6);
			
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s11, 8, 6, 7, 7, 6);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s11, 9,  6, 7, 7, 6);
	...
	public static void F3(Connection conn, XSSFWorkbook wb){
		...
		if(month == 1 || month == 2 || month == 3 || month == 4 || month == 5){
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s6, 2, 1, 5, 2, 1); // randome number lang yung 2 and 1
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s6, 3, 1, 5, 2,1);
			...
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s6, 2, 8, 12, 2,1);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s6, 3, 8, 12, 2,1);
			SqlOpsforExcelGen.certificationPerterm(conn, wb, row, cell, sp, s6, 4, 8, 12, 2,1);
		}
		else if(month == 6 || month == 7){
			SqlOpsforExcelGen.session_count(conn, wb, sp, cell, s6, 2, 6, 7,2,1);
			SqlOpsforExcelGen.session_count_incomp(conn, wb, sp, cell, s6, 3,  6, 7, 2,1);
	...
	public static void F4(Connection conn, XSSFWorkbook wb){
		...
		SqlOpsforExcelGen.count_session_weekly(conn, wb, cell, sp, s6, 2, month, exactDate, weekDate);;
		SqlOpsforExcelGen.count_session_weekly_incomp(conn, wb, cell, sp, s6, 3, month, exactDate, weekDate);;
